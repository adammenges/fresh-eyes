...
def main():
    ...
    for root, dirs, files in walklevel(basepath):
        ...
        for full_filename in files:
            ...
            zoom_viewer("ViewerBox",50)#set factor for how far you want to zoom out from viewer
            patch_first_object_on_layer("ViewerBox",(255,233,233))#set color here
            rs.LayerPrintWidth("ViewerBox", width=0.001)#set print width here
            rs.Command("PrintDisplay"+"s"+" _-Enter"+"o"+" _-Enter"+" _-Enter")#ensures lineweights are displaying
            #capture_view_antialias(os.path.join(basepath,filename+".png"), (500,500) )#changeimagesize
            #capture_view(os.path.join(basepath,filename+".png"), (500,500) )#changeimagesize
            width="800" #pixel count for width
            height="800" #pixel count for height
